...
public class ErlangDialyzerExternalAnnotator extends ExternalAnnotator<ErlangDialyzerExternalAnnotator.State, ErlangDialyzerExternalAnnotator.State>
{
	...
	public State collectInformation(@NotNull PsiFile file)
	{
		...
		Sdk sdk = ModuleUtilCore.getSdk(file, ErlangModuleExtension.class);
		if(sdk == null)
		{
			return null;
		}
	...
	public State doAnnotate(State state)
	{
		...
		try
		{
			String[] params = StringUtil.isEmptyOrSpaces(state.myCurrentPltPath) ? new String[]{state.myFilePath} : new String[]{
					"--plt",
					state.myCurrentPltPath,
					state.myFilePath
			};
