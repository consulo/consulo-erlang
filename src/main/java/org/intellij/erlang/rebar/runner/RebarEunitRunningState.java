...
public class RebarEunitRunningState extends CommandLineState
{
	...
	public ExecutionResult execute(@NotNull Executor executor, @NotNull ProgramRunner runner) throws ExecutionException
	{
		...
		RebarEunitRerunFailedTestsAction rerunAction = new RebarEunitRerunFailedTestsAction(consoleView, ((BaseTestsOutputConsoleView) consoleView)
				.getProperties());
	...
	private ConsoleView createConsoleView(Executor executor)
	{
		...
		return SMTestRunnerConnectionUtil.createConsoleWithCustomLocator("Rebar", consoleProperties, getEnvironment(),
