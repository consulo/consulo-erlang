	...
	public static class Element implements StructureViewTreeElement, ItemPresentation, NavigationItem
	{
		...
		public TreeElement[] getChildren()
		{
			...
			else if(myElement instanceof ErlangFile)
			{
				...
				for(ErlangMacrosDefinition o : macroses)
				{
					result.add(new Element(o));
				}
				for(ErlangRecordDefinition o : records)
				{
					result.add(new Element(o));
				}
				for(ErlangTypeDefinition o : types)
				{
					result.add(new Element(o));
				}
				for(ErlangFunction o : functions)
				{
					result.add(new Element(o));
				}
			}
		...
		public Image getIcon()
		{
			...
			if(myElement instanceof ErlangFunction)
			{
				...
				return ImageEffects.appendRight(ErlangIcons.FUNCTION, isPrivate ? AllIcons.Nodes.C_private : AllIcons.Nodes.C_public);
			}
